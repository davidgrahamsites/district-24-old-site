...
<title>Visual Calendar 4 Admin</title>
<style type="text/css">
<!--
body{
...
<div id="container">
	<div id="div_body">		
        ...
        <input name="selDay4"   type="hidden" id="selDay4"  onChange="changeDate('4')">
        <input name="selMonth4"  type="hidden" id="selMonth4" onChange="changeDate('4')">
        <input name="selYear4"   type="hidden" id="selYear4" onChange="changeDate('4')">
        <div id="containerVisualCalendar4">
        </div>
        
        <script type="text/javascript">initCalendar("4","ENG",true);</script>
        <?php
        }
        else
        {
