...
<title>Visual Calendar 3 Admin</title>
<style type="text/css">
<!--
body{
...
<div id="container">
	<div id="div_body">		
        ...
        <input name="selDay3"   type="hidden" id="selDay3"  onChange="changeDate('3')">
        <input name="selMonth3"  type="hidden" id="selMonth3" onChange="changeDate('3')">
        <input name="selYear3"   type="hidden" id="selYear3" onChange="changeDate('3')">
        <div id="containerVisualCalendar3">
        </div>
        
        <script type="text/javascript">initCalendar("3","ENG",true);</script>
        <?php
        }
        else
        {
