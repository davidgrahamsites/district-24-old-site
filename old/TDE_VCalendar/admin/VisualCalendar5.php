...
<title>Visual Calendar 5 Admin</title>
<style type="text/css">
<!--
body{
...
<div id="container">
	<div id="div_body">		
        ...
        <input name="selDay5"   type="hidden" id="selDay5"  onChange="changeDate('5')">
        <input name="selMonth5"  type="hidden" id="selMonth5" onChange="changeDate('5')">
        <input name="selYear5"   type="hidden" id="selYear5" onChange="changeDate('5')">
        <div id="containerVisualCalendar5">
        </div>
        
        <script type="text/javascript">initCalendar("5","ENG",true);</script>
        <?php
        }
        else
        {
