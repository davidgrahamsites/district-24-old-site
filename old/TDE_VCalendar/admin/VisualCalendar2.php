...
<title>Visual Calendar 2 Admin</title>
<style type="text/css">
<!--
body{
...
<div id="container">
	<div id="div_body">		
        ...
        <input name="selDay2"   type="hidden" id="selDay2"  onChange="changeDate('2')">
        <input name="selMonth2"  type="hidden" id="selMonth2" onChange="changeDate('2')">
        <input name="selYear2"   type="hidden" id="selYear2" onChange="changeDate('2')">
        <div id="containerVisualCalendar2">
        </div>
        
        <script type="text/javascript">initCalendar("2","ENG",true);</script>
        <?php
        }
        else
        {
