...
<title>Visual Calendar 7 Admin</title>
<style type="text/css">
<!--
body{
...
<div id="container">
	<div id="div_body">		
        ...
        <input name="selDay7"   type="hidden" id="selDay7"  onChange="changeDate('7')">
        <input name="selMonth7"  type="hidden" id="selMonth7" onChange="changeDate('7')">
        <input name="selYear7"   type="hidden" id="selYear7" onChange="changeDate('7')">
        <div id="containerVisualCalendar7">
        </div>
        
        <script type="text/javascript">initCalendar("7","ENG",true);</script>
        <?php
        }
        else
        {
